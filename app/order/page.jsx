...
// Every menu entry -- base plates, sides, and every topping/add-on alike
// -- is just its own simple item with its own price options, ordered
// independently with its own quantity. Uber-Eats style: no nesting.
